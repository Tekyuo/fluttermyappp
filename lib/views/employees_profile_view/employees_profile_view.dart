      ...
      body: Padding(
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => EmployeeReviewsScreen(employeeId: widget.emp['empID']),
                            ),
                          );
                        },
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PortfolioScreen(employeeId: widget.emp['empID']),
                            ),
                          );
                        },
                        child: AppStyles.bold(
          ...
          AppStyles.bold(
            ...
            size: AppSizes.size16,
                ...
                10.heightBox,
                AppStyles.bold(title: "Beauty Saloon", color: AppColors.textColor, size: AppSizes.size16),
                5.heightBox,
                AppStyles.normal(title: widget.emp['empSaloon'], color: AppColors.textColor.withOpacity(0.5), size: AppSizes.size14),
                10.heightBox,
