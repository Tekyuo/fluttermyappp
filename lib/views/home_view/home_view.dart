...
import 'package:fluttermyappp/views/salons_view/salons_view_all.dart';
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              20.heightBox,
              Align(alignment: Alignment.centerLeft, child: AppStyles.bold(title: "Beauty Salons", color: AppColors.blueColor, size: AppSizes.size18),
              ),
              10.heightBox,
                            ...
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  SizedBox(height: 5),
                                  AppStyles.normal(title: salonNames[index]),
                                ],
                              ),
                            ),
                          );
