...
import 'package:fluttermyappp/res/components/date_picker.dart';
import 'package:fluttermyappp/res/components/time_picker.dart';
...
class BookAppointmentView extends StatelessWidget {
  ...
  const BookAppointmentView(
      {super.key, required this.empID, required this.empName, required this.empCategory});
